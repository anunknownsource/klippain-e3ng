...
> Not ready for use yet. Use main Klippain branch until this note is removed!
...
> Klippain-E3NG:
```bash
wget -O - https://raw.githubusercontent.com/anunknownsource/klippain-e3ng/e3ng/install.sh | bash
```
...
> Klippain-E3NG:
```bash
wget -O - https://raw.githubusercontent.com/anunknownsource/klippain-e3ng/e3ng/uninstall.sh | bash
```
